...
<head>
    ...
    <title>GasFaster - Register</title>
    ...
    <section class="py-16">
        <div class="container mx-auto px-4">
            <div class="max-w-md mx-auto bg-white rounded-xl shadow-sm p-8 fade-in">
                <h2 class="text-2xl font-bold text-black mb-6 text-center">Create Your Account</h2>
                ...
                <form action="{{ route('register') }}" method="POST" id="register-form">
                    @csrf
                    <div class="mb-5">
                        <label for="name" class="block text-sm font-semibold text-black mb-2">Full Name</label>
                    ...
                    <div class="mb-5">
                        <label for="mobile_phone" class="block text-sm font-semibold text-black mb-2">Mobile Phone</label>
                        <input type="text" id="mobile_phone" name="mobile_phone" value="{{ old('mobile_phone') }}" required
                               pattern="[0-9]{10,12}" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-black text-base focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <p class="mt-6 text-center text-sm text-gray-600">
                    Already have an account? <a href="{{ route('login') }}" class="text-black font-medium hover:underline">Log in</a>
                </p>
            </div>
        </div>
    </section>
